...
class    formMain(QtGui.QMainWindow):
    ...
    def    __init__(self,name):
        ...
        self.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint)
        self.setGeometry(300,100,600,140)#xy,wh
        ...
        self.lblviewlabel.setText('If you want to view the constraints, press "Open Viewer"')
...
class rnp_Constraint_Checkeralone:
    ...
    def GetResources(self):
        ...
        return {
             ...
             'ToolTip': 'checks constraints toolTipText'
             }
