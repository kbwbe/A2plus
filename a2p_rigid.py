...
SPINSTEP_DIVISOR = 15.0
WEIGHT_LINEAR_MOVE = 0.4
WEIGHT_REFPOINT_ROTATION = 0.9
...
class Rigid():
    ...
    def getCandidates2(self, solverStage = None):
        candidates = []        
