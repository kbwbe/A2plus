    ...
    def Activated(self):
        ...
        if selection and len(selection) > 0:
            ...
            response = QtGui.QMessageBox.information(
                QtGui.QApplication.activeWindow(), u"RECURSIVE UPDATE", msg, flags
            )
        ...
        for f in filesToUpdate:
            ...
            importDoc.save()
            print(
                u"==== Assembly '{}' has been updated! =====".format(importDoc.FileName)
            )
            if importDoc != doc:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": QT_TRANSLATE_NOOP(
                "A2plus_recursiveUpdatePlanner", "Update imports recursively"
            ),
            "ToolTip": toolTip,
        }
...
FreeCADGui.addCommand(
    "a2p_recursiveUpdateImportedPartsCommand", a2p_recursiveUpdateImportedPartsCommand()
)
