...
os.system("pyside-rcc -o a2p_Resources2.py {}".format(qrc_filename))
os.system("pyside-rcc -py3 -o a2p_Resources3.py {}".format(qrc_filename))

os.system("pyside-lupdate *.py -ts translations/A2plus.ts -verbose")
"""
os.system(
